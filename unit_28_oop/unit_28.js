...
//  let goods = new Goods('VAZ_2101', 1000);
//  console.log(goods);
...
//  let goods2 = new Goods('VAZ_2107', "6500", 'perm_camera_mic');
//  goods2.draw('.out-4')
...
// let goods3 = new Goods2('VAZ_2107', "6500", 'perm_camera_mic', false);
// goods3.draw('.out-6');
...
// let valid = new Valid('stefan098@ukr.net', '12345');
// valid.validate()
...
//  let valid1_2 = new Valid('stefan098@ukr.net', '1234567');
//  valid1_2.validate()
...
//  let valid3 = new Valid2('stefan098@ukr.net', '12345')
//  valid3.validate()
//  console.log(valid3);
