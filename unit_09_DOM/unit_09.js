...
function f5() {
    let cont = out4.classList.contains('bg-4');
    out5.innerHTML = cont;
}
...
//  Task 12
// Добавьте aкнопку .b-12, которая запускает функцию f12. Функция создает через createElement div c текстом 12 и добавляет ему класс bg-12. Созданный div добавляется в out-12.


function f12() {
    let a12 = document.createElement('div');
    a12.innerHTML = '12';
    a12.classList.add('bg-12');
    document.querySelector('.out-12').appendChild(a12);
}
...
function f13() {
    let a13 = document.createElement('div');
    a13.innerHTML = "pushMe";
    a13.classList.add('bg-13');
    document.querySelector('.out-13').appendChild(a13).onclick = f13_1;
}
...
function f14() {
    let a14 = document.createElement('div');
    a14.innerHTML = "14";
    a14.classList.add('bg-14')
    document.querySelector('.out-14').prepend(a14);
}
...
function f15() {
    let a15 = document.createElement('div');
    a15.innerHTML = "15";
    a15.classList.add('bg-15');
    document.querySelector('.out-15').before(a15);
}
...
function f16() {
    let a16 = document.createElement('div');
    a16.innerHTML = "16";
    a16.classList.add('bg-16');
    document.querySelector('.out-16').after(a16);
}
...
function f17() {
    let a17 = document.createElement('div');
    a17.innerHTML = "17";
    a17.classList.add('bg-17');
    document.querySelector('.out-17').replaceWith(a17);
}
