...
const f4 = () => {
    ...
    out4.innerHTML = s4.has(i4.value);
    i4.value = '';
}
...
const f7 = () => {
    ...
    let s7 = new Set(a7);
    if(a7.length === s7.size && s7.size > 6){
        out7.innerHTML = 1;
    }else{
        out7.innerHTML = 0
    }
