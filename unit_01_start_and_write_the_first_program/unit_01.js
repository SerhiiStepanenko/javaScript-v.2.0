...
let greeting = document.getElementById('one');
...
let replacement = document.querySelector('span');
replacement.innerHTML = "world";
...
h4.innerHTML = `${"<h4>text_h4</h4>"}${"<p>text_p</p>"}`
...
a.innerHTML = 3.1415; // дроби пишутся через точку
...
out16.innerHTML = result3; //браузер преобразует число в строку и объединяет две строки вместе.
...
console.log(d2);
d2 = 5; //переназначил d2 
console.log(d2); // и вывело 5
...
console.log(divS3);
divS3 = document.querySelector('.s4'); //переназначил divS3
console.log(divS3); // и вывело блок div'a s4
...
// document.querySelector('body').innerHTML = ''; //в developer tools браузер код видит но в документе ничего не выводит