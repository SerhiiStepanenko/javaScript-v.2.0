...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=6')
    .then(data => data.text())
    .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=1&num2=10')
    .then(data => data.text())
    .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Serhii', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=2&name=Serhii',
    })
    .then(data => data.text())
    .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=6', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=3&num1=5&num2=6',
    })
    .then(data => data.text())
    .then(data => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=1&num2=10', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=4&num1=1&num2=10',
    })
    .then(data => data.text())
    .then(data => {
